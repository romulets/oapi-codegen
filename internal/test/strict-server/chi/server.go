//go:generate go run github.com/romulets/oapi-codegen/cmd/oapi-codegen --config=server.cfg.yaml ../strict-schema.yaml
//go:generate go run github.com/romulets/oapi-codegen/cmd/oapi-codegen --config=types.cfg.yaml ../strict-schema.yaml
