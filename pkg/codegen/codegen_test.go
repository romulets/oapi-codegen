...
import (
	...
	examplePetstoreClient "github.com/romulets/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/romulets/oapi-codegen/examples/petstore-expanded/echo/api"
	"github.com/romulets/oapi-codegen/pkg/util"
...
const (
	...
	remoteRefImport = `github.com/romulets/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/romulets/oapi-codegen/examples/petstore-expanded"`)
